...
@app.on_message(filters.command(GETLOG_COMMAND) & filters.user([1892491797,6199134030]))
@language
...
@app.on_message(filters.command(USAGE_COMMAND) & filters.user([1892491797,6199134030]))
@language
...
@app.on_message(filters.command(UPDATE_COMMAND) & filters.user([1892491797,6199134030]))
@language
...
@app.on_message(filters.command(REBOOT_COMMAND) & filters.user([1892491797,6199134030]))
