...
@app.on_message(filters.command(GBAN_COMMAND) & filters.user([1892491797,6199134030]))
@language
...
@app.on_message(filters.command(UNGBAN_COMMAND) & filters.user([1892491797,6199134030]))
@language
...
@app.on_message(filters.command(GBANNED_COMMAND) & filters.user([1892491797,6199134030]))
@language
